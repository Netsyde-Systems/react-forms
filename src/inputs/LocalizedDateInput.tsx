...
export function LocalizedDateInput(props: DateInputProps) {
	...
	return (
		<div className={className}>
			<InputLabel {...props} />
			<DatePicker onChange={handleChange} value={value} locale={props.locale} minDate={min} maxDate={max} showMonthDropdown showYearDropdown autoComplete='off' {...{ id, disabled }} />
			<ErrorMessage {...props} />
		</div>
	)
}

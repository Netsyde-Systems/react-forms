...
export function createNumberInput<FormT extends { [key: string]: any }>(
	...
	const handleChange = (newFieldValue: number | null) => {
		// some type hacks here... TODO: look into how to do this properly
		const coercedFieldValue = newFieldValue as any
	...
	return [
		<NumberInput id={id} label={label} value={formData[fieldName]} onChange={handleChange} disabled={isDisabled} required={isRequired} hidden={isHidden} errorMessage={errorMessage} />, 
		isValid
	]
}

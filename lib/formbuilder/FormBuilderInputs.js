...
function getInputProps(formDefinition, formData, formState, fieldName, onFormChange, language) {
    ...
    var label = getLabel(formDefinition, formData, fieldName, language);
    ...
    if (typeof (fieldDef === null || fieldDef === void 0 ? void 0 : fieldDef.isDisabled) == 'boolean')
        ...
        disabled = (_a = fieldDef === null || fieldDef === void 0 ? void 0 : fieldDef.isDisabled) === null || _a === void 0 ? void 0 : _a.call(fieldDef, fieldValue, fieldName, formData, formDefinition);
    ...
    if (fieldDef === null || fieldDef === void 0 ? void 0 : fieldDef.validators) {
        ...
        if (typeof fieldDef.validators === 'function') {
            errors.push.apply(errors, (_b = fieldDef.validators) === null || _b === void 0 ? void 0 : _b.call(fieldDef, fieldValue, fieldName, formData, formDefinition));
        }

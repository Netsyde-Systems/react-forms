...
export function createStandardInput(fieldDefinitions, formData, formState, fieldName, onChange, InputControl, subFormIndex, rootFormData) {
    var props = getInputProps(fieldDefinitions, formData, formState, fieldName, onChange, subFormIndex, rootFormData);
...
export function createOptionInput(formDefinition, formData, formState, fieldName, onChange, OptionControl, subFormIndex, rootFormData) {
    var props = getInputProps(formDefinition, formData, formState, fieldName, onChange, subFormIndex, rootFormData);
...
export function getInputProps(fieldDefinitions, formData, formState, fieldName, onFormChange, subFormIndex, rootFormData) {

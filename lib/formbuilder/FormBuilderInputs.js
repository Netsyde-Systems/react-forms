...
function getSelectOptions(formDefinition, formData, formState, fieldName, language, externalData) {
    ...
    if (fieldDef) {
        if (typeof fieldDef.selectOptions == 'object') {
            ...
            // Type HACK.  TODO: investigate
            localizedOptions = fieldDef.selectOptions({ fieldValue: fieldValue, fieldName: fieldName, formData: formData, formState: formState, formDefinition: formDefinition, externalData: externalData, language: language });
        }
    }

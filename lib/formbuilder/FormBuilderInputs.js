...
export function getInputProps(fieldDefinitions, formData, formState, fieldName, onFormChange, subFormName, subFormIndex, rootFormData) {
    ...
    var test = (_a = subFormName === null || subFormName === void 0 ? void 0 : subFormName.length) !== null && _a !== void 0 ? _a : 0;
    test++;
    ...
    if (formState.isDisabled)
        ...
        disabled = (_b = fieldDef === null || fieldDef === void 0 ? void 0 : fieldDef.isDisabled) === null || _b === void 0 ? void 0 : _b.call(fieldDef, { fieldValue: fieldValue, fieldName: fieldName, formData: formData, formDefinition: formDefinition, language: language, subFormIndex: subFormIndex, rootFormData: rootFormData });
    ...
    if (formState.isReadonly)
        ...
        readOnly = (_c = fieldDef === null || fieldDef === void 0 ? void 0 : fieldDef.isReadOnly) === null || _c === void 0 ? void 0 : _c.call(fieldDef, { fieldValue: fieldValue, fieldName: fieldName, formData: formData, formDefinition: formDefinition, language: language, subFormIndex: subFormIndex, rootFormData: rootFormData });

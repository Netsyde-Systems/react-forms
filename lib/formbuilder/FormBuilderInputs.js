...
export function createFileInput(fieldDefinitions, formData, formState, fieldName, onChange, subFormName, subFormIndex, rootFormData, fileInputConfig, externalData) {
    var props = getInputProps(fieldDefinitions, formData, formState, fieldName, onChange, subFormName, subFormIndex, rootFormData, externalData);
...
export function getInputProps(fieldDefinitions, formData, formState, fieldName, onFormChange, subFormName, subFormIndex, rootFormData, externalData) {
    ...
    var label = getLabel(fieldDefinitions, formData, formState, fieldName, language);
    ...
    if (typeof (fieldDef === null || fieldDef === void 0 ? void 0 : fieldDef.isRequired) == 'boolean')
        ...
        if (typeof requiredResult == 'boolean')
    ...
    if (required) {
        if (requiredMessages.length > 0)
            errors.push.apply(errors, requiredMessages);
        else
    ...
    if (fieldDef === null || fieldDef === void 0 ? void 0 : fieldDef.validators) {
        ...
        if (typeof fieldDef.validators === 'function') {
            errors.push.apply(errors, (_e = fieldDef.validators) === null || _e === void 0 ? void 0 : _e.call(fieldDef, getFieldSpecArgs()));
        }
    ...
    var hidden = (_f = fieldDef === null || fieldDef === void 0 ? void 0 : fieldDef.isHidden) === null || _f === void 0 ? void 0 : _f.call(fieldDef, getFieldSpecArgs());
    ...
    if (((fieldDef === null || fieldDef === void 0 ? void 0 : fieldDef.validateImmediately) && ((_g = formState.fieldsTouched) === null || _g === void 0 ? void 0 : _g[fieldName])) || formState.hasBeenValidated || externalError) {
    ...
    (_h = formState.fieldErrorConditions) !== null && _h !== void 0 ? _h : (formState.fieldErrorConditions = {});

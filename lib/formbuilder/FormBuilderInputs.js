...
export function createStandardInput(fieldDefinitions, formData, formState, fieldName, onChange, InputControl, language) {
    var _a = getInputProps(fieldDefinitions, formData, formState, fieldName, onChange, language), props = _a[0], isValid = _a[1];
    return [
        InputControl(props),
        isValid
    ];
...
function getInputProps(fieldDefinitions, formData, formState, fieldName, onFormChange, language) {
    var _a, _b, _c;
    ...
    if (typeof (fieldDef === null || fieldDef === void 0 ? void 0 : fieldDef.isRequired) == 'boolean')
        ...
        required = fieldDef.isRequired(fieldValue, fieldName, formData, fieldDefinitions);
    ...
    if (typeof (fieldDef === null || fieldDef === void 0 ? void 0 : fieldDef.isDisabled) == 'boolean')
        ...
        disabled = (_a = fieldDef === null || fieldDef === void 0 ? void 0 : fieldDef.isDisabled) === null || _a === void 0 ? void 0 : _a.call(fieldDef, fieldValue, fieldName, formData, fieldDefinitions);
    // let's check for validation messsages
    var errors = [];
    var errorMessage = undefined;
    if (required) {
        errors.push.apply(errors, requiredFieldValidator(fieldValue, fieldName, formData, fieldDefinitions));
    }
    if (fieldDef === null || fieldDef === void 0 ? void 0 : fieldDef.validators) {
        ...
        if (typeof fieldDef.validators === 'function') {
            errors.push.apply(errors, (_b = fieldDef.validators) === null || _b === void 0 ? void 0 : _b.call(fieldDef, fieldValue, fieldName, formData, fieldDefinitions));
        }
        // or an array of functions
        else if (Array.isArray(fieldDef.validators)) {
            errors.push.apply(errors, fieldDef.validators.flatMap(function (err) { return err(fieldValue, fieldName, formData, fieldDefinitions); }));
        }
            ...
            switch (typeof fieldValue) {
                case 'string':
                    if (fieldDef.validators.max)
                        errors.push.apply(errors, getMaxLengthValidator(fieldDef.validators.max, label)(fieldValue, fieldName, formData, fieldDefinitions));
                    if (fieldDef.validators.min)
                        errors.push.apply(errors, getMinLengthValidator(fieldDef.validators.min, label)(fieldValue, fieldName, formData, fieldDefinitions));
                    break;
                case 'number':
                    if (fieldDef.validators.max)
                        errors.push.apply(errors, getMaxValidator(fieldDef.validators.max, label)(fieldValue, fieldName, formData, fieldDefinitions));
                    if (fieldDef.validators.min)
                        errors.push.apply(errors, getMinValidator(fieldDef.validators.min, label)(fieldValue, fieldName, formData, fieldDefinitions));
                    break;
                case undefined:
    ...
    var hidden = (_c = fieldDef === null || fieldDef === void 0 ? void 0 : fieldDef.isHidden) === null || _c === void 0 ? void 0 : _c.call(fieldDef, fieldValue, fieldName, formData, fieldDefinitions);
    ...
    var onChange = function (newFieldValue) {
        ...
        else if (typeof (fieldDef === null || fieldDef === void 0 ? void 0 : fieldDef.disallowChange) === 'function' && fieldDef.disallowChange(coercedFieldValue, fieldName, formData, fieldDefinitions)) {

...
export function createStandardInput(fieldDefinitions, formData, formState, fieldName, onChange, InputControl, subFormName, subFormIndex, rootFormData, controlProps) {
...
export function createMaskedInput(fieldDefinitions, formData, formState, fieldName, onChange, subFormName, subFormIndex, rootFormData, mask, controlProps) {
    var props = getInputProps(fieldDefinitions, formData, formState, fieldName, onChange, subFormName, subFormIndex, rootFormData);
    props.controlProps = controlProps;
    var maskedProps = __assign(__assign({}, props), { mask: mask });
    return MaskedInput(maskedProps);
}
export function createOptionInput(formDefinition, formData, formState, fieldName, onChange, OptionControl, subFormName, subFormIndex, rootFormData, controlProps) {
...
export function getInputProps(fieldDefinitions, formData, formState, fieldName, onFormChange, subFormName, subFormIndex, rootFormData) {
    ...
    var externalErrorSet = externalErrorMap === null || externalErrorMap === void 0 ? void 0 : externalErrorMap.get(fieldValue);
    var externalErrors = !!externalErrorSet ? Array.from(externalErrorSet) : [];
    ...
    if (fieldDef === null || fieldDef === void 0 ? void 0 : fieldDef.validators) {
        ...
        if (typeof fieldDef.validators === 'function') {
            errors.push.apply(errors, (_d = fieldDef.validators) === null || _d === void 0 ? void 0 : _d.call(fieldDef, { fieldValue: fieldValue, fieldName: fieldName, formData: formData, formDefinition: formDefinition, language: language, subFormIndex: subFormIndex, rootFormData: rootFormData }));
        }
    ...
    var hidden = (_e = fieldDef === null || fieldDef === void 0 ? void 0 : fieldDef.isHidden) === null || _e === void 0 ? void 0 : _e.call(fieldDef, { fieldValue: fieldValue, fieldName: fieldName, formData: formData, formDefinition: formDefinition, language: language, subFormIndex: subFormIndex, rootFormData: rootFormData });
    ...
    var onChange = function (newFieldValue, rawValue) {
        ...
        if (typeof (fieldDef === null || fieldDef === void 0 ? void 0 : fieldDef.disallowChange) === 'object' && (coercedFieldValue === null || coercedFieldValue === void 0 ? void 0 : coercedFieldValue.toString().length) > fieldDef.disallowChange.maxLength) {
        ...
        else if (typeof (fieldDef === null || fieldDef === void 0 ? void 0 : fieldDef.disallowChange) === 'function' && fieldDef.disallowChange({ fieldValue: coercedFieldValue, rawValue: rawValue, fieldName: fieldName, formData: formData, formDefinition: formDefinition, language: language, subFormIndex: subFormIndex, rootFormData: rootFormData })) {
            ...
            if (fieldDef === null || fieldDef === void 0 ? void 0 : fieldDef.onChange) {
                formData = fieldDef.onChange({ fieldValue: formData[fieldName], rawValue: rawValue, fieldName: fieldName, formData: formData, formDefinition: formDefinition, language: language, subFormIndex: subFormIndex, rootFormData: rootFormData });
            }

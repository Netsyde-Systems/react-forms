...
var FormBuilder = /** @class */ (function () {
    ...
    FormBuilder.prototype.linkStandardControl = function (fieldName, InputControl, customInputProps, controlProps) {
        ...
        var inputControl = createStandardInput(this.formDefinition.fields || {}, newFormData, newFormState, fieldName, handleChange, InputControl, customInputProps, this.subFormName, this.subFormIndex, this.rootFormData, controlProps !== null && controlProps !== void 0 ? controlProps : {}, this.externalData);
        return inputControl;
    };
    ...
    Object.defineProperty(FormBuilder.prototype, "hasExternalErrors", {
        get: function () {
            ...
            var _a, _b;
            var _c;
            (_a = (_c = this.formState).fieldErrorConditions) !== null && _a !== void 0 ? _a : (_c.fieldErrorConditions = {});
            this.validateSubForms();
            var hasExternalErrors = Object.entries((_b = this.formState.externalErrorConditions) !== null && _b !== void 0 ? _b : {})
                .some(function (_a) {

...
var FormBuilder = /** @class */ (function () {
    function FormBuilder(formDefinition, formData, formState, onFormDataUpdate, onFormStateUpdate, subFormName, subFormIndex, rootFormData, originalFormData) {
        ...
        this.maskedInput = function (fieldName, mask, controlProps) {
            ...
            var inputControl = createMaskedInput(_this.formDefinition.fields || {}, newFormData, newFormState, fieldName, handleChange, _this.subFormName, _this.subFormIndex, _this.rootFormData, mask, controlProps);
            return inputControl;
        };

...
var FormBuilder = /** @class */ (function () {
    function FormBuilder(formDefinition, formData, formState, onFormDataUpdate, onFormStateUpdate, subFormIndex, rootFormData) {
        ...
        formDefinition.fields && Object.entries(formDefinition.fields).forEach(function (_a) {
            ...
            getInputProps(formDefinition.fields, formData, formState, fieldName, function () { return null; }, undefined, undefined);
        });
    }
    ...
    FormBuilder.prototype.linkStandardControl = function (fieldName, InputControl) {
        ...
        var inputControl = createStandardInput(this.formDefinition.fields || {}, newFormData, newFormState, fieldName, handleChange, InputControl, this.subFormIndex, this.rootFormData);
        return inputControl;
    };
    FormBuilder.prototype.linkOptionControl = function (fieldName, OptionControl) {
        ...
        var inputControl = createOptionInput(this.formDefinition.fields || {}, newFormData, newFormState, fieldName, handleChange, OptionControl, this.subFormIndex, this.rootFormData);
        return inputControl;
    };

        ...
        var subFormController = {
            addInstance: function () {
                ...
                if (subFormDefinition === null || subFormDefinition === void 0 ? void 0 : subFormDefinition.newSubForm) {
                    newSubForm = subFormDefinition.newSubForm({ fieldValue: _this.formData[fieldName], fieldName: fieldName, formData: _this.formData, formDefinition: _this.formDefinition, language: _this.language });
                }

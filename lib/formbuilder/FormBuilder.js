...
var FormBuilder = /** @class */ (function () {
    function FormBuilder(formDefinition, formData, formState, language, onFormDataUpdate, onFormStateUpdate, onLanguageUpdate, rowIndex) {
        var _this = this;
    ...
    FormBuilder.prototype.linkStandardControl = function (fieldName, InputControl) {
        ...
        var _a = createStandardInput(this.formDefinition.fields || {}, newFormData, newFormState, fieldName, handleChange, InputControl, this.language), inputControl = _a[0], isValid = _a[1];
    ...
    FormBuilder.prototype.linkOptionControl = function (fieldName, OptionControl) {
        ...
        var _a = createOptionInput(this.formDefinition.fields || {}, newFormData, newFormState, fieldName, handleChange, OptionControl, this.language), inputControl = _a[0], isValid = _a[1];
        this.updateValidity(isValid);
        return inputControl;
    };
    ...
    FormBuilder.prototype.subFormLoop = function (fieldName, subFormConstructor) {
        ...
        var elements = subFormData === null || subFormData === void 0 ? void 0 : subFormData.map(function (subFormDatum, rowIndex) {
            ...
            var subFormBuilder = new FormBuilder(subFormDef.formDefinition, subFormDatum, subFormState, _this.language, handleFormDataUpdate, undefined, undefined, rowIndex);

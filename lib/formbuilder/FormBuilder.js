...
var FormBuilder = /** @class */ (function () {
    ...
    FormBuilder.prototype.linkStandardControl = function (fieldName, InputControl) {
        ...
        var inputControl = createStandardInput(this.formDefinition.fields || {}, newFormData, newFormState, fieldName, handleChange, InputControl, this.subFormName, this.subFormIndex, this.rootFormData);
        return inputControl;
    };
    FormBuilder.prototype.linkOptionControl = function (fieldName, OptionControl) {
        ...
        var inputControl = createOptionInput(this.formDefinition.fields || {}, newFormData, newFormState, fieldName, handleChange, OptionControl, this.subFormName, this.subFormIndex, this.rootFormData);
        return inputControl;
    };
    ...
    FormBuilder.prototype.subFormLoop = function (fieldName, subFormConstructor) {
        ...
        var elements = subFormData === null || subFormData === void 0 ? void 0 : subFormData.map(function (subFormDatum, rowIndex) {
            ...
            var fieldErrorConditions = ((_d = (_c = _this.formState.fieldErrorConditions) === null || _c === void 0 ? void 0 : _c[fieldName]) !== null && _d !== void 0 ? _d : []);
            var _f = _this.formState, hasBeenValidated = _f.hasBeenValidated, language = _f.language, isDisabled = _f.isDisabled, isReadonly = _f.isReadonly;
            var subFormState = {
                fieldsTouched: (_e = fieldsTouched[rowIndex]) !== null && _e !== void 0 ? _e : {},
                fieldErrorConditions: fieldErrorConditions[rowIndex !== null && rowIndex !== void 0 ? rowIndex : {}],

...
var FormBuilder = /** @class */ (function () {
    function FormBuilder(formDefinition, formData, formState, onFormDataUpdate, onFormStateUpdate, subFormIndex, rootFormData) {
        var _this = this;
        ...
        this.currency = function (fieldName) { return _this.linkStandardControl(fieldName, Currency); };
    ...
    FormBuilder.prototype.linkStandardControl = function (fieldName, InputControl) {
        ...
        var _a = createStandardInput(this.formDefinition.fields || {}, newFormData, newFormState, fieldName, handleChange, InputControl, this.subFormIndex, this.rootFormData), inputControl = _a[0], isValid = _a[1];
    ...
    FormBuilder.prototype.linkOptionControl = function (fieldName, OptionControl) {
        ...
        var _a = createOptionInput(this.formDefinition.fields || {}, newFormData, newFormState, fieldName, handleChange, OptionControl, this.subFormIndex, this.rootFormData), inputControl = _a[0], isValid = _a[1];
        this.updateValidity(isValid);
        return inputControl;
    };
    ...
    FormBuilder.prototype.subFormLoop = function (fieldName, subFormConstructor) {
        ...
        var elements = subFormData === null || subFormData === void 0 ? void 0 : subFormData.map(function (subFormDatum, rowIndex) {
            ...
            var _c = _this.formState, hasBeenValidated = _c.hasBeenValidated, language = _c.language, isDisabled = _c.isDisabled, isReadonly = _c.isReadonly;
            var subFormState = {
            ...
            var subFormBuilder = new FormBuilder(subFormDef.formDefinition, subFormDatum, subFormState, handleFormDataUpdate, undefined, rowIndex, _this.formData);

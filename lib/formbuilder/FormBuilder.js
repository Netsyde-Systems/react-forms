...
var FormBuilder = /** @class */ (function () {
    function FormBuilder(formDefinition, formData, formState, language, onFormDataUpdate, onFormStateUpdate, onLanguageUpdate) {
        var _this = this;
    ...
    FormBuilder.prototype.linkStandardControl = function (fieldName, InputControl) {
        ...
        var _a = createStandardInput(this.formDefinition, newFormData, newFormState, fieldName, handleChange, InputControl, this.language), inputControl = _a[0], isValid = _a[1];
    ...
    FormBuilder.prototype.linkOptionControl = function (fieldName, OptionControl) {
        ...
        var _a = createOptionInput(this.formDefinition, newFormData, newFormState, fieldName, handleChange, OptionControl, this.language), inputControl = _a[0], isValid = _a[1];
        this.updateValidity(isValid);
        return inputControl;
    };

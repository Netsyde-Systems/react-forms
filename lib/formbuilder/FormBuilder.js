...
import { createMaskedInput, createOptionInput, createStandardInput, getInputProps } from "./FormBuilderInputs";
...
var FormBuilder = /** @class */ (function () {
    ...
    externalData) {
        ...
        this.maskedInput = function (fieldName, mask, controlProps) {
            ...
            var inputControl = createMaskedInput(_this.formDefinition.fields || {}, newFormData, newFormState, fieldName, handleChange, _this.subFormName, _this.subFormIndex, _this.rootFormData, mask, controlProps !== null && controlProps !== void 0 ? controlProps : {}, _this.externalData);
            return inputControl;
        };
        ...
        formDefinition.fields && Object.entries(formDefinition.fields).forEach(function (_a) {
            ...
            getInputProps(formDefinition.fields, formData, formState, fieldName, function () { return null; }, undefined, undefined, undefined, externalData);
        });
    ...
    FormBuilder.prototype.setExternalErrors = function (fieldName, fieldValue, errorMessages) {
        var _a, _b;
        var _c;
        // let newFormState = Object.assign({}, this.formState)
        var newFormState = this.formState;
        (_a = newFormState.externalErrorConditions) !== null && _a !== void 0 ? _a : (newFormState.externalErrorConditions = {});
        (_b = (_c = newFormState.externalErrorConditions)[fieldName]) !== null && _b !== void 0 ? _b : (_c[fieldName] = new Map());
        if (!newFormState.externalErrorConditions[fieldName].has(fieldValue)) {
            newFormState.externalErrorConditions[fieldName].set(fieldValue, new Set());
        }
        newFormState.externalErrorConditions[fieldName].set(fieldValue, new Set(errorMessages));
        // this.onFormStateUpdate?.(newFormState)
    };
    FormBuilder.prototype.addExternalErrors = function (fieldName, fieldValue, errorMessages) {
        var _a, _b, _c;
        var existingErrors = (_c = (_b = (_a = this.formState.externalErrorConditions) === null || _a === void 0 ? void 0 : _a[fieldName]) === null || _b === void 0 ? void 0 : _b.get(fieldValue)) !== null && _c !== void 0 ? _c : new Set();
        errorMessages.forEach(function (errorMessage) { return existingErrors.add(errorMessage); });
    ...
    FormBuilder.prototype.linkStandardControl = function (fieldName, InputControl, controlProps) {
        ...
        var inputControl = createStandardInput(this.formDefinition.fields || {}, newFormData, newFormState, fieldName, handleChange, InputControl, this.subFormName, this.subFormIndex, this.rootFormData, controlProps !== null && controlProps !== void 0 ? controlProps : {}, this.externalData);
        return inputControl;
    };
    FormBuilder.prototype.linkOptionControl = function (fieldName, OptionControl, controlProps) {
        ...
        var inputControl = createOptionInput(this.formDefinition.fields || {}, newFormData, newFormState, fieldName, handleChange, OptionControl, this.subFormName, this.subFormIndex, this.rootFormData, controlProps !== null && controlProps !== void 0 ? controlProps : {}, this.externalData);
        return inputControl;
    };

...
export declare function getInputProps<FormT, FieldT, LanguageT extends string | undefined>(fieldDefinitions: FieldDefinitions<FormT, LanguageT>, formData: FormData<FormT>, formState: FormState<FormT, LanguageT>, fieldName: OnlyKeysOfType<FormT, FieldT>, onFormChange: (formData: FormData<FormT>) => void, subFormIndex: number | undefined, rootFormData: FormData<any> | undefined): InputProps<FieldT>;

...
export declare function createMaskedInput<FormT, LanguageT extends string | undefined>(fieldDefinitions: FieldDefinitions<FormT, LanguageT>, formData: FormData<FormT>, formState: FormState<FormT, LanguageT>, fieldName: OnlyKeysOfType<FormT, string>, onChange: (data: FormData<FormT>) => void, subFormName: string | undefined, subFormIndex: number | undefined, rootFormData: FormData<any> | undefined, mask: Mask, controlProps?: InputHTMLAttributes<any>): JSX.Element;

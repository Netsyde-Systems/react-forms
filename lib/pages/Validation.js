...
export function Validation() {
    ...
    return (_jsxs("div", { className: 'validation page', children: [_jsx("h1", { children: "Validation Tests" }), _jsxs(FormInspector, { formBuilder: rfDeferred, children: [_jsx("h2", { children: "Validation (Deffered)" }), _jsxs("div", { className: 'control-grid', children: [_jsxs("div", { className: 'control-row', children: [_jsx("div", { className: 'control-cell', children: rfDeferred.textInput('reqString') }), _jsx("div", { className: 'control-cell', children: rfDeferred.textInput('minString') }), _jsx("div", { className: 'control-cell', children: rfDeferred.textInput('maxString') })] }), _jsxs("div", { className: 'control-row', children: [_jsx("div", { className: 'control-cell', children: rfDeferred.textInput('allString') }), _jsx("div", { className: 'control-cell', children: rfDeferred.textInput('customString') }), _jsx("div", { className: 'control-cell', children: rfDeferred.textInput('multiFnString') })] }), _jsx("div", { className: 'control-row', children: _jsx("div", { className: 'control-cell', children: rfDeferred.dateInput('reqDate') }) })] })] }), _jsx("button", { onClick: function () { return rfDeferred.validate(); }, children: "Validate" }), _jsxs(FormInspector, { formBuilder: rfImmediate, children: [_jsx("h2", { children: "Validation (Immediate)" }), _jsxs("div", { className: 'control-grid', children: [_jsxs("div", { className: 'control-row', children: [_jsx("div", { className: 'control-cell', children: rfImmediate.textInput('reqString') }), _jsx("div", { className: 'control-cell', children: rfImmediate.textInput('minString') }), _jsx("div", { className: 'control-cell', children: rfImmediate.textInput('maxString') })] }), _jsxs("div", { className: 'control-row', children: [_jsx("div", { className: 'control-cell', children: rfImmediate.textInput('allString') }), _jsx("div", { className: 'control-cell', children: rfImmediate.textInput('customString') }), _jsx("div", { className: 'control-cell', children: rfImmediate.textInput('multiFnString') })] }), _jsx("div", { className: 'control-row', children: _jsx("div", { className: 'control-cell', children: rfImmediate.dateInput('reqDate') }) })] })] }), _jsxs(FormInspector, { formBuilder: rfForced, children: [_jsx("h2", { children: "Validate (Forced)" }), _jsx("div", { className: 'control-grid', children: _jsxs("div", { className: 'control-row', children: [_jsx("div", { className: 'control-cell', children: rfForced.textInput('maxString') }), _jsx("div", { className: 'control-cell', children: rfForced.textInput('customString') })] }) })] })] }));
}

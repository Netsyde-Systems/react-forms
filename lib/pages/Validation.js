...
var deferredDefinition = {
    ...
    customString: { label: 'Must be of length 10 and contain "sheep"', validators: function (fieldValue) {
            var errors = [];
...
var immediateDefinition = Object.entries(deferredDefinition).reduce(function (formDef, _a) {
...
var forcedDefinition = {
    ...
    customString: { label: 'Cannot contain "sheep"', disallowChange: function (fieldValue) {
...
export function Validation() {
    ...
    return (_jsxs("div", __assign({ className: 'validation page' }, { children: [_jsx("h1", { children: "Validation Tests" }), _jsx(Well, __assign({ title: 'Validation (Deferred)', buttonDefs: [{ text: 'Validate', onClick: function () { return rfDeferred.validate(); } }] }, { children: _jsxs("div", __assign({ className: 'control-grid' }, { children: [_jsxs("div", __assign({ className: 'control-row' }, { children: [_jsx("div", __assign({ className: 'control-cell' }, { children: rfDeferred.textInput('reqString') })), _jsx("div", __assign({ className: 'control-cell' }, { children: rfDeferred.textInput('minString') })), _jsx("div", __assign({ className: 'control-cell' }, { children: rfDeferred.textInput('maxString') }))] })), _jsxs("div", __assign({ className: 'control-row' }, { children: [_jsx("div", __assign({ className: 'control-cell' }, { children: rfDeferred.textInput('allString') })), _jsx("div", __assign({ className: 'control-cell' }, { children: rfDeferred.textInput('customString') })), _jsx("div", __assign({ className: 'control-cell' }, { children: rfDeferred.textInput('multiFnString') }))] }))] })) })), _jsx(Well, __assign({ title: 'Validation (Immediate)' }, { children: _jsxs("div", __assign({ className: 'control-grid' }, { children: [_jsxs("div", __assign({ className: 'control-row' }, { children: [_jsx("div", __assign({ className: 'control-cell' }, { children: rfImmediate.textInput('reqString') })), _jsx("div", __assign({ className: 'control-cell' }, { children: rfImmediate.textInput('minString') })), _jsx("div", __assign({ className: 'control-cell' }, { children: rfImmediate.textInput('maxString') }))] })), _jsxs("div", __assign({ className: 'control-row' }, { children: [_jsx("div", __assign({ className: 'control-cell' }, { children: rfImmediate.textInput('allString') })), _jsx("div", __assign({ className: 'control-cell' }, { children: rfImmediate.textInput('customString') })), _jsx("div", __assign({ className: 'control-cell' }, { children: rfImmediate.textInput('multiFnString') }))] }))] })) })), _jsx(Well, __assign({ title: 'Validation (Forced)' }, { children: _jsx("div", __assign({ className: 'control-grid' }, { children: _jsxs("div", __assign({ className: 'control-row' }, { children: [_jsx("div", __assign({ className: 'control-cell' }, { children: rfForced.textInput('maxString') })), _jsx("div", __assign({ className: 'control-cell' }, { children: rfForced.textInput('customString') }))] })) })) })), _jsx("h2", { children: "Deferred Form Data" }), _jsx("pre", { children: JSON.stringify(rfDeferred.formData, null, 2) }), _jsx("h2", { children: "Deferred Form Types" }), _jsx("pre", { children: JSON.stringify(getTypeMap(rfDeferred.formData), null, 2) }), _jsx("h2", { children: "Immediate Form Data" }), _jsx("pre", { children: JSON.stringify(rfImmediate.formData, null, 2) }), _jsx("h2", { children: "Immediate Form Types" }), _jsx("pre", { children: JSON.stringify(getTypeMap(rfImmediate.formData), null, 2) }), _jsx("h2", { children: "Forced Form Data" }), _jsx("pre", { children: JSON.stringify(rfForced.formData, null, 2) }), _jsx("h2", { children: "Immediate Form Types" }), _jsx("pre", { children: JSON.stringify(getTypeMap(rfForced.formData), null, 2) })] })));
}

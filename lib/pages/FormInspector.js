...
export var FormInspector = function (_a) {
    ...
    var dataInspector = inspectorIsOpen ?
        ...
        null;
    return (_jsxs("div", __assign({ className: className }, { children: [_jsx("div", __assign({ className: 'form' }, { children: children })), _jsxs("div", __assign({ className: 'data-inspector' }, { children: [_jsx("button", __assign({ onClick: function () { return setInspectorIsOpen(!inspectorIsOpen); } }, { children: buttonText })), dataInspector] }))] })));
};

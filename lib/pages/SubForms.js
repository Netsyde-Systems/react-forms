...
export function Localization() {
    ...
    return (_jsxs(FormInspector, __assign({ formBuilder: rf }, { children: [_jsx("div", __assign({ className: 'forms page' }, { children: _jsx(Well, __assign({ title: 'SubForms', buttonDefs: [{ text: 'Validate', onClick: function () { return rf.validate(); } }] }, { children: _jsxs("div", __assign({ className: 'control-grid' }, { children: [_jsx("h2", { children: "Main Form" }), _jsxs("div", __assign({ className: 'control-row' }, { children: [_jsx("div", __assign({ className: 'control-cell' }, { children: rf.textInput('stringProperty') })), _jsx("div", __assign({ className: 'control-cell' }, { children: rf.numberInput('numberProperty') })), _jsx("div", __assign({ className: 'control-cell' }, { children: rf.textSelect('language') }))] })), _jsx("h2", { children: "Sub Forms" }), rf.subFormPanel('subFormsProperty', function (controller) {
                                ...
                                return (_jsx(Button, { text: 'Add New', onClick: controller.addInstance }));
                                            ...
                                            return (_jsxs("tr", { children: [_jsx("td", { children: srf.dateInput('date') }), _jsx("td", { children: srf.currency('cost') }), _jsx("td", { children: srf.checkbox('exclude') }), _jsx("td", { children: _jsx(Button, { text: 'Delete', onClick: controller.deleteInstance }) })] }, controller.subFormIndex));
                                        }) }), _jsx("tfoot", { children: _jsxs("tr", { children: [_jsx("td", {}), _jsxs("td", { children: [rf.localize(SumLabel), " $", sumCosts((_b = rf.formData) === null || _b === void 0 ? void 0 : _b.req2SubFormsProperty)] }), _jsx("td", {}), _jsx("td", {})] }) })] })] })) })) })), _jsx("hr", {}), _jsx("div", { children: "TODO:  Figure out why we have to pass the SubFormShape as a generic constraint" }), _jsx("div", { children: "TODO:  Figure out how to infer the shape from the field name instead" })] })));
}

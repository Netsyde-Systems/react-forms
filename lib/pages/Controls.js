...
function Controls() {
    ...
    return (_jsxs("div", { className: 'controls page', children: [_jsx("h1", { children: "Control Tests" }), _jsxs("div", { className: 'control-grid', children: [_jsxs("div", { className: 'control-row', children: [_jsx("div", { className: 'control-cell', children: _jsx(TextInput, __assign({ id: 'txtInput', label: 'Text Input', value: textInputValue, onChange: setTextInputValue, placeholder: "Text Input Placeholder" }, sharedProperties)) }), _jsx("div", { className: 'control-cell', children: nullableValueMessage(textInputValue) }), _jsx("div", { className: 'control-cell', children: _jsx(NumberInput, __assign({ id: 'numInput', label: 'Number Input', value: numberInputValue, onChange: setNumberInputValue, placeholder: "Number Input Placeholder" }, sharedProperties)) }), _jsx("div", { className: 'control-cell', children: nullableValueMessage(numberInputValue) })] }), _jsxs("div", { className: 'control-row', children: [_jsx("div", { className: 'control-cell', children: _jsx(TextSelect, __assign({ id: 'selTextInput', label: 'Text Select', value: selectTextValue, onChange: setSelectTextValue, placeholder: "Select Text Placeholder", selectOptions: textSelectOptions }, sharedProperties)) }), _jsx("div", { className: 'control-cell', children: nullableValueMessage(selectTextValue) }), _jsx("div", { className: 'control-cell', children: _jsx(NumberSelect, __assign({ id: 'selNumInput', label: 'Number Select', value: selectNumberValue, onChange: setSelectNumberValue, placeholder: "Select Number Placeholder", selectOptions: numberSelectOptions }, sharedProperties)) }), _jsx("div", { className: 'control-cell', children: nullableValueMessage(selectNumberValue) })] }), _jsxs("div", { className: 'control-row', children: [_jsx("div", { className: 'control-cell', children: _jsx(TextRadio, __assign({ id: 'rdInput', label: 'Text Radio', value: RadioValue, onChange: setRadioValue }, sharedProperties, { selectOptions: textSelectOptions })) }), _jsx("div", { className: 'control-cell', children: nullableValueMessage(RadioValue) }), _jsx("div", { className: 'control-cell', children: _jsx(NumberRadio, __assign({ id: 'selNumRadioInput', label: 'Number Radio', value: NumberRadioValue, onChange: setNumberRadioValue, selectOptions: numberSelectOptions }, sharedProperties)) }), _jsx("div", { className: 'control-cell', children: nullableValueMessage(NumberRadioValue) })] }), _jsxs("div", { className: 'control-row', children: [_jsx("div", { className: 'control-cell', children: _jsx(TextArea, __assign({ id: 'txtAreaInput', label: 'Text Area', value: textAreaValue, onChange: setTextAreaValue, placeholder: "Text Area Placeholder" }, sharedProperties, { controlProps: { rows: 5, title: 'text area title check' } })) }), _jsx("div", { className: 'control-cell', children: nullableValueMessage(textAreaValue) })] }), _jsxs("div", { className: 'control-row', children: [_jsx("div", { className: 'control-cell', children: _jsx(FileInput, __assign({ id: 'fileInput', label: 'File Input', value: fileValue, onChange: setFileValue, placeholder: 'Upload File', multiple: true }, sharedProperties)) }), _jsx("div", { className: 'control-cell', children: nullableValueMessage(fileValue) })] }), _jsxs("div", { className: 'control-row', children: [_jsx("div", { className: 'control-cell', children: _jsx(MaskedInput, __assign({ id: 'txtMaskedInput', label: 'Masked Input (X12)', value: textMaskedValue, onChange: setMaskedValue, mask: 'a00' }, sharedProperties)) }), _jsx("div", { className: 'control-cell', children: nullableValueMessage(textMaskedValue) }), _jsx("div", { className: 'control-cell', children: _jsx(CheckBox, __assign({ id: 'chkInput', label: 'Checkbox Input', value: checkboxValue, onChange: setCheckboxValue }, sharedProperties)) }), _jsx("div", { className: 'control-cell', children: nullableValueMessage(checkboxValue) })] }), _jsxs("div", { className: 'control-row', children: [_jsx("div", { className: 'control-cell', children: _jsx(DateInput, __assign({ id: 'datInput', label: 'Date', value: dateInputValue, onChange: setDateInputValue }, sharedProperties)) }), _jsxs("div", { className: 'control-cell', children: [nullableValueMessage(dateInputValue), _jsx("br", {}), "ISO GMT DATE: ", dateToIsoGmtShortDateString(dateInputValue)] }), _jsx("div", { className: 'control-cell', children: _jsx(LocalizedDateInput, __assign({ locale: dateLocales[locale], id: 'locDatInput', label: 'Localized Date', value: localizedDateInputValue, onChange: setLocalizedDateInputValue }, sharedProperties)) }), _jsxs("div", { className: 'control-cell', children: [nullableValueMessage(localizedDateInputValue), _jsx("br", {}), "ISO GMT DATE: ", dateToIsoGmtShortDateString(localizedDateInputValue)] })] }), _jsxs("div", { className: 'control-row', children: [_jsx("div", { className: 'control-cell', children: _jsx(PostalCode, __assign({ id: 'txtPostalCode', label: 'Postal Code', value: postalCodeValue, onChange: setPostalCodeValue }, sharedProperties)) }), _jsx("div", { className: 'control-cell', children: nullableValueMessage(postalCodeValue) }), _jsx("div", { className: 'control-cell', children: _jsx(EmailAddress, __assign({ id: 'txtEmail', label: 'Email', value: emailValue, onChange: setEmailValue }, sharedProperties)) }), _jsx("div", { className: 'control-cell', children: nullableValueMessage(emailValue) })] }), _jsxs("div", { className: 'control-row', children: [_jsx("div", { className: 'control-cell', children: _jsx(PhoneNumber, __assign({ id: 'txtPhoneNumber', label: 'Phone Number', value: phoneValue, onChange: setPhoneValue }, sharedProperties)) }), _jsx("div", { className: 'control-cell', children: nullableValueMessage(phoneValue) }), _jsx("div", { className: 'control-cell', children: _jsx(Currency, __assign({ id: 'txtCurrency', label: 'Currency', value: dollarValue, onChange: setDollarValue }, sharedProperties)) }), _jsx("div", { className: 'control-cell', children: nullableValueMessage(dollarValue) })] })] }), _jsx(DemoControlPanel, { children: buttonDefs.map(function (bd, ix) { return _jsx("button", { onClick: bd.onClick, children: bd.text }, ix); }) })] }));
}

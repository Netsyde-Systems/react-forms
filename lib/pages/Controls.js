...
function Controls() {
    ...
    var _q = React.useState(), fileValue = _q[0], setFileValue = _q[1];
    var _r = React.useState(false), controlsHaveErrors = _r[0], setControlErrors = _r[1];
    var _s = React.useState(false), controlsAreDisabled = _s[0], disableControls = _s[1];
    var _t = React.useState(false), controlsAreHidden = _t[0], hideControls = _t[1];
    var _u = React.useState(false), inputsAreRequired = _u[0], makeInputsRequired = _u[1];

...
function Controls() {
    ...
    var _p = React.useState(), postalCodeValue = _p[0], setPostalCodeValue = _p[1];
    var _q = React.useState(), emailValue = _q[0], setEmailValue = _q[1];
    var _r = React.useState(), fileValue = _r[0], setFileValue = _r[1];
    var _s = React.useState(false), controlsHaveErrors = _s[0], setControlErrors = _s[1];
    var _t = React.useState(false), controlsAreDisabled = _t[0], disableControls = _t[1];
    var _u = React.useState(false), controlsAreHidden = _u[0], hideControls = _u[1];
    var _v = React.useState(false), inputsAreRequired = _v[0], makeInputsRequired = _v[1];

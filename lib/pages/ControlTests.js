...
function ControlTests() {
    ...
    var _j = React.useState(null), textMaskedValue = _j[0], setMaskedValue = _j[1];
    var _k = React.useState(null), phoneValue = _k[0], setPhoneValue = _k[1];
    var _l = React.useState(null), postalCodeValue = _l[0], setPostalCodeValue = _l[1];
    var _m = React.useState(false), controlsHaveErrors = _m[0], setControlErrors = _m[1];
    var _o = React.useState(false), controlsAreDisabled = _o[0], disableControls = _o[1];
    var _p = React.useState(false), controlsAreHidden = _p[0], hideControls = _p[1];
    var _q = React.useState(false), inputsAreRequired = _q[0], makeInputsRequired = _q[1];

...
function ControlTests() {
    ...
    var _j = React.useState(null), NumberRadioValue = _j[0], setNumberRadioValue = _j[1];
    var _k = React.useState(null), textAreaValue = _k[0], setTextAreaValue = _k[1];
    var _l = React.useState(null), textMaskedValue = _l[0], setMaskedValue = _l[1];
    var _m = React.useState(null), phoneValue = _m[0], setPhoneValue = _m[1];
    var _o = React.useState(null), postalCodeValue = _o[0], setPostalCodeValue = _o[1];
    var _p = React.useState(false), controlsHaveErrors = _p[0], setControlErrors = _p[1];
    var _q = React.useState(false), controlsAreDisabled = _q[0], disableControls = _q[1];
    var _r = React.useState(false), controlsAreHidden = _r[0], hideControls = _r[1];
    var _s = React.useState(false), inputsAreRequired = _s[0], makeInputsRequired = _s[1];

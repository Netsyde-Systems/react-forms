...
function ControlTests() {
    ...
    var _h = React.useState(null), RadioValue = _h[0], setRadioValue = _h[1];
    var _j = React.useState(null), textAreaValue = _j[0], setTextAreaValue = _j[1];
    var _k = React.useState(null), textMaskedValue = _k[0], setMaskedValue = _k[1];
    var _l = React.useState(null), phoneValue = _l[0], setPhoneValue = _l[1];
    var _m = React.useState(null), postalCodeValue = _m[0], setPostalCodeValue = _m[1];
    var _o = React.useState(false), controlsHaveErrors = _o[0], setControlErrors = _o[1];
    var _p = React.useState(false), controlsAreDisabled = _p[0], disableControls = _p[1];
    var _q = React.useState(false), controlsAreHidden = _q[0], hideControls = _q[1];
    var _r = React.useState(false), inputsAreRequired = _r[0], makeInputsRequired = _r[1];

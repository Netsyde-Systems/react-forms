...
export var dateToIsoGmtShortDateString = function (date) { var _a; return (_a = date === null || date === void 0 ? void 0 : date.toISOString().substring(0, 10)) !== null && _a !== void 0 ? _a : ''; };
export var shortDateStringToDate = function (date) {
    var dateParts = date === null || date === void 0 ? void 0 : date.split('-').map(Number);
...
export var Config = {
    DeploymentDirectory: (_a = process === null || process === void 0 ? void 0 : process.env.REACT_APP_DEPLOYMENT_DIRECTORY) !== null && _a !== void 0 ? _a : ''
};

...
export function createTextInput2(formDefinition, formData, formState, fieldName, onChange) {
    var _a = getInputProps(formDefinition, formData, formState, fieldName, onChange), props = _a[0], isValid = _a[1];
    return [
        function () { return TextInput(props); },
        isValid
    ];
}
...
export function createCheckbox(formDefinition, formData, formState, fieldName, onChange) {
    var _a = getInputProps(formDefinition, formData, formState, fieldName, onChange), props = _a[0], isValid = _a[1];
    return [

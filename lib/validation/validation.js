...
function getErrorLabel(fieldName, formDefinition) {
    var _a, _b;
    var label = (_b = (_a = formDefinition[fieldName]) === null || _a === void 0 ? void 0 : _a.label) !== null && _b !== void 0 ? _b : fieldName;
    return label;
}
export var requiredFieldValidator = function (fieldValue, fieldName, formData, formDefinition) {
    var label = getErrorLabel(fieldName, formDefinition);

...
export function NumberInput(props) {
    ...
    return (_jsxs("div", __assign({ className: className }, { children: [_jsx(InputLabel, __assign({}, props)), _jsx("input", __assign({ type: 'number', value: (_b = props.value) !== null && _b !== void 0 ? _b : '', onChange: handleChange }, { id: id, disabled: disabled, required: required, placeholder: placeholder })), _jsx(ErrorMessage, __assign({}, props))] })));
}

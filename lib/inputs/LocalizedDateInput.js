...
export function LocalizedDateInput(props) {
    ...
    return (_jsxs("div", { className: className, children: [_jsx(InputLabel, __assign({}, props)), _jsx(DatePicker, { onChange: handleChange, value: value, locale: props.locale, id: id, disabled: disabled }), _jsx(ErrorMessage, __assign({}, props))] }));
}

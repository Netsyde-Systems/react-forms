...
export function LocalizedDateInput(props) {
    ...
    return (_jsxs("div", __assign({ className: className }, { children: [_jsx(InputLabel, __assign({}, props)), _jsx(DatePicker, __assign({ onChange: handleChange, value: value, locale: props.locale, minDate: min, maxDate: max }, { id: id, disabled: disabled })), _jsx(ErrorMessage, __assign({}, props))] })));
}

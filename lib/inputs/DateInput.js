...
export function DateInput(props) {
    ...
    return (_jsxs("div", { className: className, children: [_jsx(InputLabel, __assign({}, props)), _jsx("input", __assign({}, controlProps, { type: 'date', value: value, onChange: handleChange, id: id, disabled: disabled })), _jsx(ErrorMessage, __assign({}, props))] }));
}

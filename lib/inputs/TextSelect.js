...
export function TextSelect(props) {
    ...
    return (_jsxs("div", __assign({ className: className }, { children: [_jsx(InputLabel, __assign({}, props)), _jsx("select", __assign({}, controlProps, { value: (_a = props.value) !== null && _a !== void 0 ? _a : '', onChange: handleChange }, { id: id, disabled: disabled, required: required }, { children: options })), _jsx(ErrorMessage, __assign({}, props))] })));
}

...
it('renders option as disabled', function () {
    ...
    var numberRadio = render(_jsx(TextRadio, { id: 'selTxtRadioInput', onChange: function () { return null; }, label: 'Expected Text Radio', value: undefined, selectOptions: selectOptions }));

...
it('displays supplied value', function () {
    var control = render(_jsx(CheckBox, { id: 'chkInput', value: undefined, onChange: function () { return null; } }));
...
it('calls onChange as expected', function () {
    ...
    var control = render(_jsx(CheckBox, { id: 'chkInput', value: undefined, onChange: handleChange }));
    var input = control.getByRole('checkbox');

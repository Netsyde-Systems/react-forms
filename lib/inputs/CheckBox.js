...
export function CheckBox(props) {
    ...
    return (_jsxs("div", { className: className, children: [_jsx("input", __assign({}, controlProps, { type: "checkbox", checked: !!props.value, onChange: handleChange, id: id, disabled: disabled, required: required, readOnly: readOnly })), _jsx(InputLabel, __assign({}, props)), _jsx("br", {}), _jsx(ErrorMessage, __assign({}, props))] }));
}

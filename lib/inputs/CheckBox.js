...
export function CheckBox(props) {
    ...
    return (_jsxs("div", __assign({ className: className }, { children: [_jsx("input", __assign({ type: "checkbox", checked: !!props.value, onChange: handleChange }, { id: id, disabled: disabled })), _jsx(InputLabel, __assign({}, props)), _jsx("br", {}), _jsx(ErrorMessage, __assign({}, props))] })));
}

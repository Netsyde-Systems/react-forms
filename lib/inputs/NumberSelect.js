...
export function NumberSelect(props) {
    ...
    var id = props.id, value = props.value, onChange = props.onChange, label = props.label, errorMessage = props.errorMessage, required = props.required, hidden = props.hidden, placeholder = props.placeholder, selectOptions = props.selectOptions, disabled = props.disabled, disallowBlank = props.disallowBlank;

...
export function NumberRadio(props) {
    var id = props.id, value = props.value, onChange = props.onChange, label = props.label, errorMessage = props.errorMessage, required = props.required, hidden = props.hidden, selectOptions = props.selectOptions, disabled = props.disabled, readOnly = props.readOnly;

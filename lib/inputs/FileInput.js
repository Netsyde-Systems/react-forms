...
export function FileInput(props) {
    ...
    var id = props.id, disabled = props.disabled, readOnly = props.readOnly, required = props.required, multiple = props.multiple, _a = props.maxFileSizeInBytes, maxFileSizeInBytes = _a === void 0 ? DEFAULT_MAX_FILE_SIZE_IN_BYTES : _a, placeholder = props.placeholder;
    ...
    var uploadSection = readOnly ? null : (_jsxs("section", { className: uploadClassName, children: [_jsxs("button", { type: "button", onClick: handleUploadBtnClick, disabled: disabled || readOnly, children: [_jsx("i", { className: "folder" }), _jsx("span", { children: placeholder !== null && placeholder !== void 0 ? placeholder : '🡅' })] }), _jsx("div", { className: className, children: _jsx("input", { ref: fileInputField, type: 'file', title: '', value: '', onChange: handleNewFileUpload, multiple: multiple, id: id, disabled: disabled, readOnly: readOnly, required: required }) })] }));
    return (_jsxs("div", { className: className, children: [_jsx(InputLabel, __assign({}, props)), uploadSection, _jsx("article", { className: 'preview', children: _jsx("section", { className: 'file-list', children: Object.keys(fileLookup).map(function (fileName, index) {
                        ...
                        return (_jsx("section", { className: 'file', children: _jsxs("div", { children: [isImageFile && (_jsx("img", { src: URL.createObjectURL(file), alt: "file preview ".concat(index) })), _jsxs("div", { "data-isimagefile": isImageFile, className: 'meta-data', children: [_jsx("span", { className: 'filename', children: file.name }), _jsxs("aside", { children: [_jsxs("span", { children: [convertBytesToKB(file.size), " kB"] }), deleteIcon] })] })] }) }, fileName));
                    }) }) }), _jsx(ErrorMessage, __assign({}, props))] }));
}

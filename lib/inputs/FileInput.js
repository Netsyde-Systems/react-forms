...
export function FileInput(props) {
    ...
    var filledExcludedFileExtensions = Object.assign({}, excludedFileExtensions, { criteria: (_b = excludedFileExtensions === null || excludedFileExtensions === void 0 ? void 0 : excludedFileExtensions.criteria) !== null && _b !== void 0 ? _b : DEFAULT_EXCLUDED_FILE_EXTENSIONS });
    ...
    var addNewFiles = function (newFiles) {
        ...
        var _loop_1 = function (file) {
            ...
            if (filledExcludedFileExtensions.criteria.some(function (ext) { return file.name.toLowerCase().endsWith(ext); })) {
                (_b = filledExcludedFileExtensions.onRejected) === null || _b === void 0 ? void 0 : _b.call(filledExcludedFileExtensions, file);
                return "continue";
            }
            if (((_c = acceptedFileExtensions === null || acceptedFileExtensions === void 0 ? void 0 : acceptedFileExtensions.criteria) === null || _c === void 0 ? void 0 : _c.length) && !acceptedFileExtensions.criteria.some(function (ext) { return file.name.toLowerCase().endsWith(ext); })) {
                (_d = acceptedFileExtensions.onRejected) === null || _d === void 0 ? void 0 : _d.call(acceptedFileExtensions, file);
                return "continue";
            }
            if (!multiple) {

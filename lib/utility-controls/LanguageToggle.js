...
export function LanguageSelect(props) {
    ...
    return _jsx(TextSelect, { id: 'lang-select', value: currentLanguage, onChange: function (val) { return onLanguageChange(val); }, selectOptions: languageOptions, disallowBlank: true, errorMessage: false, label: 'Language' });
}

...
export var FormInspector = function (_a) {
    ...
    var dataInspector = inspectorIsOpen ?
        ...
        null;
    return (_jsxs("div", __assign({ className: 'form-inspector' }, { children: [_jsx("button", __assign({ className: 'inspect', onClick: function () { return setInspectorIsOpen(!inspectorIsOpen); } }, { children: buttonText })), _jsx("div", __assign({ className: 'inspection-results' }, { children: dataInspector })), children] })));
};
